...
var form_data_1 = __importDefault(__webpack_require__(5443));
var const_1 = __webpack_require__(6001);
var field_1 = __webpack_require__(1150);
var record_1 = __webpack_require__(8085);
var view_1 = __webpack_require__(5841);
...
var abort = __webpack_require__(9355)
  , async = __webpack_require__(7913)
  ;
...
var iterate    = __webpack_require__(2851)
  , initState  = __webpack_require__(3996)
  , terminator = __webpack_require__(1044)
  ;
...
var settle = __webpack_require__(5836);
var buildURL = __webpack_require__(2488);
var buildFullPath = __webpack_require__(8097);
var parseHeaders = __webpack_require__(9658);
var isURLSameOrigin = __webpack_require__(5280);
var createError = __webpack_require__(8621);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(2650);
...
var stringify = __webpack_require__(2749);
var parse = __webpack_require__(9715);
var formats = __webpack_require__(3952);
...
var utils = __webpack_require__(454);
var normalizeHeaderName = __webpack_require__(4876);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(1658);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __webpack_require__(3522);
  }
  return adapter;
}
...
var utils = __webpack_require__(454);
var transformData = __webpack_require__(7267);
var isCancel = __webpack_require__(7630);
var defaults = __webpack_require__(1973);
...
var utils = __webpack_require__(454);
var bind = __webpack_require__(354);
var Axios = __webpack_require__(3165);
var mergeConfig = __webpack_require__(2141);
var defaults = __webpack_require__(1973);
...
axios.Cancel = __webpack_require__(1050);
axios.CancelToken = __webpack_require__(2825);
axios.isCancel = __webpack_require__(7630);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __webpack_require__(4554);
...
module.exports = __webpack_require__(2061);
...
var utils = __webpack_require__(9209);
var formats = __webpack_require__(3952);
...
var Cancel = __webpack_require__(1050);
...
var async = __webpack_require__(7913)
  , abort = __webpack_require__(9355)
  ;
...
var utils = __webpack_require__(454);
var buildURL = __webpack_require__(2488);
var InterceptorManager = __webpack_require__(3421);
var dispatchRequest = __webpack_require__(2012);
var mergeConfig = __webpack_require__(2141);
...
var httpFollow = (__webpack_require__(5972).http);
var httpsFollow = (__webpack_require__(5972).https);
var url = __webpack_require__(7016);
var zlib = __webpack_require__(3106);
var pkg = __webpack_require__(4888);
var createError = __webpack_require__(8621);
var enhanceError = __webpack_require__(3643);
...
var util = __webpack_require__(9023);
var Stream = (__webpack_require__(2203).Stream);
var DelayedStream = __webpack_require__(1003);
...
exports = module.exports = __webpack_require__(9083);
exports.log = log;
...
var util = __webpack_require__(9209);
...
var serialOrdered = __webpack_require__(1500);
...
var CombinedStream = __webpack_require__(3564);
var util = __webpack_require__(9023);
...
var asynckit = __webpack_require__(7377);
var populate = __webpack_require__(3244);
...
var debug = __webpack_require__(7780)("follow-redirects");
...
"use strict";
module.exports = require("n8n-workflow");
...
var logging_1 = __webpack_require__(35);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Vika = void 0;
var axios_1 = __importDefault(__webpack_require__(2667));
// import mpAdapter from 'axios-miniprogram-adapter';
var qs_1 = __importDefault(__webpack_require__(1824));
var const_1 = __webpack_require__(6001);
var datasheet_1 = __webpack_require__(4026);
var node_1 = __webpack_require__(1648);
var space_1 = __webpack_require__(8324);
var utils_1 = __webpack_require__(9691);
var iframe_1 = __webpack_require__(3116);
...
module.exports =
{
  parallel      : __webpack_require__(9790),
  serial        : __webpack_require__(4225),
  serialOrdered : __webpack_require__(1500)
};
...
if (typeof process === 'undefined' || process.type === 'renderer') {
  module.exports = __webpack_require__(3920);
} else {
  module.exports = __webpack_require__(8434);
}
...
var defer = __webpack_require__(6181);
...
var isAbsoluteURL = __webpack_require__(5527);
var combineURLs = __webpack_require__(2178);
...
var datasheet_1 = __webpack_require__(161);
...
try {
  var supportsColor = __webpack_require__(9478);
...
exports.humanize = __webpack_require__(971);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(6594), exports);
...
__exportStar(__webpack_require__(2990), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Vika = exports.VikaNode = void 0;
const n8n_workflow_1 = __webpack_require__(5974);
const vika_1 = __webpack_require__(1418);
class VikaNode {
    constructor() {
        this.description = {
            displayName: '维格表格',
    ...
    async execute() {
        ...
        const vika = new vika_1.Vika({ token: credentials.apiToken });
                ...
                if (resource === 'record') {
                    ...
                    switch (operation) {
                        ...
                        case 'getAll':
                            ...
                            if (options.fields) {
                                queryParams.fields = options.fields.split(',').map((f) => f.trim());
                            }
                            if (options.sort && options.sort.sortField) {
                                queryParams.sort = options.sort.sortField.map((s) => ({
                                    field: s.field,
                                    order: s.order,
                                }));
                            }
                            ...
                            if (options.recordIds) {
                                queryParams.recordIds = options.recordIds.split(',').map((id) => id.trim());
                            }
                            ...
                            break;
                        case 'create':
                            const createFields = this.getNodeParameter('fields', i);
                            const createData = {};
                            ...
                            break;
                        case 'update':
                            const updateRecordId = this.getNodeParameter('recordId', i);
                            const updateFields = this.getNodeParameter('fields', i);
                            const updateData = {};
                            ...
                            break;
                        case 'delete':
                            const deleteRecordId = this.getNodeParameter('recordId', i);
...
exports.VikaNode = VikaNode;
exports.Vika = VikaNode;
